...
// «פסטה שמנת» ⇒ «פסטה ילדים» — הכרטיס מונה שמנת/רוזה/עגבניות (יותם, 6.9)
const kids = [
  { name: "פסטה ילדים", desc: "פסטה שמנת / רוזה / עגבניות / ללא רוטב, עם פרמז'ן.", ingredients: ["פסטה", "פרמז'ן"] },
  { name: "המבורגר ילדים", desc: "120 גרם בשר בקר, חסה ועגבנייה על לחמנייה", ingredients: ["בשר בקר", "חסה", "עגבנייה", "לחמנייה"] },
  { name: "פיש קידס", desc: "אצבעות פילה דניס בטמפורה עם צ'יפס", ingredients: ["פילה דניס", "טמפורה", "צ'יפס"] },
];
const kp = kids.map((d) => d.name);
ok(resolveDish(kp, "פסטה שמנת", kids) === "פסטה ילדים" && resolveDish(kp, "פסטה עגבניות", kids) === "פסטה ילדים", "«פסטה שמנת» / «פסטה עגבניות» ⇒ פסטה ילדים (מהכרטיס)");
ok(resolveDish(kp, "המבורגר בקר", kids) === "המבורגר ילדים" && resolveDish(kp, "פסטה ברוטב עגבניות עם בשר", kids) === null, "המבורגר בקר ⇒ המבורגר ילדים; מילה שלא בכרטיס ⇒ null");
