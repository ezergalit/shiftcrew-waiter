    ...
    <Frame>
      ...
      <div className="px-4 pb-6 space-y-4">
        <div className="rounded-3xl p-5 border border-[rgba(34,192,140,0.25)] space-y-2.5"
          style={{ background: "linear-gradient(150deg,rgba(34,192,140,0.12),rgba(15,92,70,0.16))" }}>
          {[
            // מסעדה שהמשימות דלוקות אצלה (העור הקלאסי) מקבלת את הטאב שלה בסיכום —
            // בלי זה המדריך מתאר אפליקציה עם טאב אחד פחות ממה שהמלצר יראה.
            ...(session?.features?.tasks === false ? [] : [["📋", "משימות המשמרת", "מה לסמן בפתיחה ובסגירה."]]),
