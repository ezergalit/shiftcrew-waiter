...
export const STOPS = {
  ...
  "menu-group": ({ menu }) => (menu ? insideOf(menu) : "הקטגוריות של התפריט הזה, וכמה מנות בכל אחת."),
  ...
  "menu-cat": ({ cat, items }) => ((items || []).some(hasWarning)
    ...
    : null),
  "menu-dish": ({ items }) => `כל מה שצריך לדעת על ה${itemNoun(items).one}. הקישו על אזהרה בצבע כדי לראות מה היא כוללת.`,
  ...
  about: ({ hasGuide }) => (hasGuide
    ? "מי אנחנו וכללי הבית — מה שהמנהל רוצה שתדעו לפני משמרת."
    : "קצת עלינו — מה שהמנהל רוצה שתדעו לפני משמרת."),
  ...
  "learn-group": ({ menu }) => (menu
    ? `${menu}. תיכנסו לקטגוריה על מנת לתרגל לקראת הבוחן.`
    : "תיכנסו על מנת לתרגל לקראת הבוחן."),
  "learn-cat": ({ cat }) => (cat
    ? `${cat}. תיכנסו על מנת לתרגל לקראת הבוחן.`
    : "תיכנסו על מנת לתרגל לקראת הבוחן."),
