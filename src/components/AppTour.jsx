...
const STEPS = [
  ...
  },
  {
    ...
    body: "כשתכירו מספיק מנות בקטגוריה, יופיע בה כפתור בוחן — עם שעון. עוברים בוחן בכל קטגוריה, ורק אחרי שעוברים את כולם נפתח מבחן התפריט המלא. הציונים הם התעודה שלכם במסעדה, והמנהל/ת רואה אותם.",
  },
  {
