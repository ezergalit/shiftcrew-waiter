...
const STEPS = [
  {
    ...
    body: "זה המסך הראשון: ברכה, ומתחתיה כל מה שצריך לעשות היום, ממוספר לפי סדר החשיבות שהמנהל/ת קבעו. המספר לא מתחלף — הוא דרגת החשיבות, לא מקום ברשימה.",
  },
  {
  ...
  },
  {
    ...
    body: "כל קטגוריה מסתיימת במבחן, ולמעלה מחכה מבחן התפריט המלא. הציונים הם התעודה שלכם במסעדה והמנהל/ת רואה אותם — התרגול הוא רק האימון לקראתם.",
  },
  {
