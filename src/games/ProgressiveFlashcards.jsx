...
export default function ProgressiveFlashcards({ items, label, firstId, initialProgress, onRate, onDone, onExam, examReady, slim = false, merged = false, coachSlot = null }) {
  ...
  if (checkpoint === "exam") return (
    <div className="h-screen max-w-md mx-auto flex flex-col items-center justify-center gap-4 px-8 text-center bg-[#0c0d10] text-[#eef0f6]" dir="rtl">
      ...
      <p className="text-sm text-[#8a8aa0] leading-relaxed">רוצים לבדוק את עצמכם?</p>
  ...
  return (
    <div className="h-screen max-w-md mx-auto flex flex-col bg-[#0c0d10] text-[#eef0f6]" dir="rtl">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 gap-2.5">
        ...
        {/* שתי נקודות = כמה המנה הזו קרובה ל«מוכרת». בלי שורת הסבר: המלצר רואה
            אותן נדלקות ומבין לבד, וכלל שמסבירים אותו ביום הראשון הוא רעש (יותם, 14.9). */}
